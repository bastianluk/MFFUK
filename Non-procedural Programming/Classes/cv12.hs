...
data TreeAB a b = Leaf b | NodeAB a (TreeAB a b) (TreeAB a b) deriving (Show)

-- TODO: Co se stane, když typu z předchozí úlohy předám jen první ze dvou argumentů?
-- type TreeStringB = TreeAB String
...
-- > fmap (*2) (Node 5 EmptyTree EmptyTree)
